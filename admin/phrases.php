 ...
 */
    ...
    class main_phrasesPage extends Page
    {
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('main_phrasesssearch', $this->dataset,
                array('id', 'name', 'domain_id_domain_name', 'lang_id_full_name', 'category', 'subcategory', 'text'),
                array($this->RenderText('Id'), $this->RenderText('Name'), $this->RenderText('Domain Id'), $this->RenderText('Lang Id'), $this->RenderText('Category'), $this->RenderText('Subcategory'), $this->RenderText('Text')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('main_phrasesasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('text', $this->RenderText('Text')));
        }
        ...
        protected function AddFieldColumns(Grid $grid)
        {
            ...
            $column->SetFullTextWindowHandlerName('main_phrasesGrid_text_handler_list');
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        }
        ...
        protected function AddSingleRecordViewColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('main_phrasesGrid_text_handler_view');
            $grid->AddSingleRecordViewColumn($column);
        }
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new TextAreaEdit('text_edit', 50, 8);
        ...
        public function GetModalGridDeleteHandler() { return 'main_phrases_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'main_phrasesGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
            ...
            $column = new TextViewColumn('text', 'Text', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'main_phrasesGrid_text_handler_list', $column);
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for text field
            //
            $column = new TextViewColumn('text', 'Text', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'main_phrasesGrid_text_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            return $result;
        }
    ...
    try
    {
        $Page = new main_phrasesPage("phrases.php", "main_phrases", GetCurrentUserGrantForDataSource("main.phrases"), 'UTF-8');
        $Page->SetShortCaption('Phrases');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Main.Phrases');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("main.phrases"));
