    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">1<font style="color:Grey;">2</font>1 Real Estate</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" href="#team"><?=$_L->Team?></a>
                    </li>
                    <li>
    ...
    <header>
        <div class="container">
            <div class="intro-text">
                <div class="intro-lead-in"><?=$_L->WelcomeToOurStudio?></div>
                <div class="intro-heading"><?=$_L->ItsNiceToMeetYou?></div>
                <a href="#services" class="page-scroll btn btn-xl"><?=$_L->TellMeMore?></a>
            </div>
        </div>
    </header>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading"><?=$_L->Services?></h2>
                    <h3 class="section-subheading text-muted"><?=$_L->ServicesDescription?>.</h3>
                </div>
            </div>

            <div class="row text-center">
	<?php 
			$articles = $_E->GetArticlesByCategory('services');
	...
	?>	
	           <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        ...
                        <i class="fa fa-<?=$ar->picture?> fa-stack-1x fa-inverse"></i>
                    </span>
                    <h4 class="service-heading"><?=$ar->shortText1?></h4>
...
?>
	...
	<!--
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading"><?=$_L->Portfolio?></h2>
    ...
    <section id="about">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading"><?=$_L->About?></h2>
                    <h3 class="section-subheading text-muted">Lorem ipsum dolor sit amet consectetur.</h3>
                </div>
            </div>
            <div class="row">
...
?>                        <li class="timeline-inverted">
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <span class="copyright"><?=$_L->Copyright?> <?=date("Y")?></span>
                </div>
                <div class="col-md-4">
                    <ul class="list-inline social-buttons">
